...
<body onload="gerarImagem()">
    ...
    $query = "UPDATE avaliacoes SET correta_4_2='" . $correta . "', selecionada_4_2='" . $selecionada . "', pulou_4_2='" . $pulou . "', tempo_4_2='" . $tempo_gasto . "' WHERE id='" . $formId . "';";
	...
	<div class="page">
		<div class="form">
			<form action="page5_4.php" method="post" class="testes" id="testes">
