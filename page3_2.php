...
function gerarImagem () {
	...
	icones[random].src = "images/image_captcha_resized/49.png";
...
<body onload="gerarImagem()">
    ...
    $query = "UPDATE avaliacoes SET correta_2_1='" . $correta . "', selecionada_2_1='" . $selecionada . "', pulou_2_1='" . $pulou . "', tempo_2_1='" . $tempo_gasto . "' WHERE id='" . $formId . "';";
	...
	<div class="page">
		<div class="form">
			<form action="page3_3.php" method="post" class="testes" id="testes">
				<table class="testes_tabela">
					<tr>
						<td colspan=4 class="testes_titulo">Selecione o carro:</td>
					</tr>
