...
<body onload="gerarImagem()">
    ...
    $query = "UPDATE avaliacoes SET correta_4_3='" . $correta . "', selecionada_4_3='" . $selecionada . "', pulou_4_3='" . $pulou . "', tempo_4_3='" . $tempo_gasto . "' WHERE id='" . $formId . "';";
	...
	<div class="page">
		<div class="form">
			<form action="page5_5.php" method="post" class="testes" id="testes">
