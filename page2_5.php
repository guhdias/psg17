...
<body onload="gerarImagem()">
    ...
    $query = "UPDATE avaliacoes SET imagem_1_4='" . $imagem . "', resposta_1_4='" . $resposta . "', pulou_1_4='" . $pulou . "', tempo_1_4='" . $tempo_gasto . "' WHERE id='" . $formId . "';";
	...
	<div class="page">
		<div class="form">
			<form action="page2_6.php" method="post" class="testes" id="testes" onsubmit="return false;">
