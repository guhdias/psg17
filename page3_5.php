...
function gerarImagem () {
	...
	icones[random].src = "images/image_captcha_resized/52.png";
...
<body onload="gerarImagem()">
    ...
    $query = "UPDATE avaliacoes SET correta_2_4='" . $correta . "', selecionada_2_4='" . $selecionada . "', pulou_2_4='" . $pulou . "', tempo_2_4='" . $tempo_gasto . "' WHERE id='" . $formId . "';";
	...
	<div class="page">
		<div class="form">
			<form action="page3_6.php" method="post" class="testes" id="testes">
				<table class="testes_tabela">
					<tr>
						<td colspan=4 class="testes_titulo">Selecione o guarda-chuva:</td>
					</tr>
					...
					<tr>
						<td colspan=4 class="testes_progresso"><img alt="Progresso 5/5" src="images/progress_bar/progress_bar_05.png"></td>
					</tr>
