...
<body>
    ...
    $query = "UPDATE avaliacoes SET correta_2_5='" . $correta . "', selecionada_2_5='" . $selecionada . "', pulou_2_5='" . $pulou . "', tempo_2_5='" . $tempo_gasto . "' WHERE id='" . $formId . "';";
	...
	<div class="page">
		<div class="form">
			<form action="page4_1.php" method="post" class="avaliacao" id="avaliacao">
				<table class="avaliacao_tabela">
					<tr>
						<td class="avaliacao_titulo">Avalie o tipo de teste 2</td>
					</tr>
					<tr>
