...
<body onload="gerarImagem()">
    ...
    $query = "UPDATE avaliacoes SET imagem_1_2='" . $imagem . "', resposta_1_2='" . $resposta . "', pulou_1_2='" . $pulou . "', tempo_1_2='" . $tempo_gasto . "' WHERE id='" . $formId . "';";
	...
	<div class="page">
		<div class="form">
			<form action="page2_4.php" method="post" class="testes" id="testes" onsubmit="return false;">
