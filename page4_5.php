...
<body onload="gerarImagem()">
    ...
    $query = "UPDATE avaliacoes SET flag_3_4='" . $flag . "', pulou_3_4='" . $pulou . "', tempo_3_4='" . $tempo_gasto . "' WHERE id='" . $formId . "';";
	...
	<div class="page">
		<div class="form">
			<form action="page4_6.php" method="post" class="testes" id="testes">
