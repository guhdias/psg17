...
<body onload="gerarImagem()">
    ...
    $query = "UPDATE avaliacoes SET flag_3_3='" . $flag . "', pulou_3_3='" . $pulou . "', tempo_3_3='" . $tempo_gasto . "' WHERE id='" . $formId . "';";
	...
	<div class="page">
		<div class="form">
			<form action="page4_5.php" method="post" class="testes" id="testes">
